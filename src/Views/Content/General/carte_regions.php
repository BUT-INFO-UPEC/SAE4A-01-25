...
<style>
    #map-container {
        ...
        align-items: center;
        width: 100%;
        height: 80vh; /* Ajuste la hauteur à 80% de la fenêtre */
        margin: 20px auto;
        margin-left: 150px; /* Décale tout le cadre vers la droite */
    }
    ...
    #map path:hover {
        fill: #007bff !important; /* Mettre en surbrillance la région au survol */
